...
public class ObjectDetector : MonoBehaviour
{
    ...
    private void InitializeScreen()
    {
        ...
        screen.gameObject.GetComponent<RawImage>().texture = useWebcam ? webcamTexture : imageTexture;
    ...
    void Start()
    {
        ...
        imageTexture = screen.gameObject.GetComponent<RawImage>().texture;
    ...
    public void ScaleBoundingBoxes()
    {
        ...
        for (int i = 0; i < objectInfoArray.Length; i++)
        {
            ...
            float minScreenDim = Mathf.Min(screen.localScale.x, screen.localScale.y);
            ...
            float displayScale = Screen.height / screen.localScale.y;
            ...
            if (mirrorScreen && useWebcam) x0 = screen.localScale.x - x0 - width;
            ...
            objectInfoArray[i].x0 += (Screen.width - screen.localScale.x * displayScale) / 2;
        }
    }
